    ...
    <div class="banner lazy">
        <div class="row">
            <form action="#" name="bookdemo" class="bookDemoHome col-md-4" id="form-id">
                ...
                <input data-role="none" placeholder="Email *" required="true" type="email" />
                <input data-role="none" placeholder="Pincode *" required="true" type="text" />
                <button data-role="none" type="submit" value="Submit" onclick="document.getElementById('form-id').submit();"></button>
            </form>
        </div>
    </div>
    <div class="row teaser">
        <div class="col-md-12">
            <h3>“Piyo Pure, Jiyo More”</h3>
            <p>Reverse Osmosis System+ Ultra-violet Ray purification+ Ultra-Filtration for any residual bacteria and germs. 
            </p>
        </div>
        <div class="col-md-3">

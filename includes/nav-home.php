    ...
    <div class="row">
        ...
        <div class="righthead col-md-9" id="nav_box">
            <div class="searchBox">
                ...
                <div class="searchBar">
                    Search now
                    <form class="form-inline" data-role="none">
                        <span class="form-group-sm form-inline" data-role="none">
                            <button data-role="none" type="submit" class="searchSubmit"><i class="glyphicon glyphicon-search"></i></button>
                            <input data-role="none" type="text" class="search-field" />
                        </span>
                    </form>
                </div>
            </div>
